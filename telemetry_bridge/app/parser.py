        ...
        try:
            ...
            return {
                ...
                "data": {
                    ...
                    "accel": int(fields[8]),
                    "brake": int(fields[9]),
                    "frontDist": int(fields[10]),
                    "leftDist": int(fields[11]),
                    "rightDist": int(fields[12]),
                    "ttc": float(fields[13]),
                    "collisionWarn": int(fields[14]),
                    "bsdLeft": int(fields[15]),
                    "bsdRight": int(fields[16]),
                    "alarmLevel": int(fields[17]),
